...
const StudentLogin = () => {
    ...
    return (
        // <div className="flex flex-col min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-white">
        //     <div className="w-full max-w-screen-lg shadow-lg rounded-lg h-[800px]">
        //         <div className='flex lg:flex-row flex-col'>
        //             <div className='w-[50%] p-8 my-auto rounded-l-lg'>
        //                 <div>
        //                     <a href="/student">
        //                         <img
        ...
        //                         <h2 className='text-gray-900 font-bold text-lg text-center w-3/4 mx-auto font-serif'>
        //                             “Train up a child in the way he should go; even when he is old he will not depart from it.“
        //                         </h2>
        //                         <span className='text-center pt-2 text-gray-800 text-md italic font-bold font-serif'>Proverbs 22:6</span>
        //                     </div>
        //                 </div>
        //             </div>
        //             <div className='w-[50%] bg-[#1dbd28] p-8 rounded-r-lg'>
        //                 <form className="my-10 space-y-6" onSubmit={loginHandler}>
        //                     <div className="flex flex-col space-y-4 rounded-md shadow-sm relative">
        //                         <h4 className='text-center font-bold text-3xl text-white font-BlackHanSans'>Sign in as a Student</h4>
        //                         <p 
        ...
        //                         <button
        //                             type="submit"
        //                             className="mx-auto group relative flex justify-center rounded-md border border-transparent bg-[#FF6464] py-2 px-4 text-md font-medium text-white hover:bg-opacity-75 transition duration-200 focus:outline-none focus:ring-2 focus:ring-greenborder-green-700 focus:ring-offset-2"
        //                         >
        //                             Login
        //                         </button>
        //                     </div>
        ...
        <div className="flex flex-col lg:flex-row min-h-screen bg-white">
            ...
            {/* Logo */}
                ...
                >
                    <h1 className="text-3xl lg:text-4xl font-bold mb-6 lg:mb-8 text-gray-900 text-center">Login as a Student</h1>
